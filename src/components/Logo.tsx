...
const Logo = () => {
  return (
    ...
    >
      ...
      <text x="100" y="30" fontFamily="Arial" fontSize="20" fill="#3c4a5d" fontWeight="bold">ДЕЙВИД</text>
      <text x="100" y="48" fontFamily="Arial" fontSize="14" fill="#759eb8" letterSpacing="1">ГРУП</text>
    </svg>
  );
};
