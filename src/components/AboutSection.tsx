      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.6
            ...
            <h2 className="text-3xl md:text-4xl font-bold">За Дейвид Груп</h2>
          ...
          <div className="pl-0 md:pl-12">
            <div className="relative">
              {timelineItems.map((item, index) => <TimelineItem key={index} year={item.year} title={item.title} delay={item.delay} />)}
            </div>
          </div>
        </div>
      </div>
