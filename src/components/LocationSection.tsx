...
const LocationSection = () => {
  ...
  return <section id="location" className="section-padding bg-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          delay: 0.2
            ...
            <div className="w-full h-full bg-david-accent4/50 relative flex items-center justify-center">
              <img src={`https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/${center.lng},${center.lat},15,0/600x400?access_token=pk.dummy`} alt="Map of Силистра" className="w-full h-full object-cover opacity-50" />
